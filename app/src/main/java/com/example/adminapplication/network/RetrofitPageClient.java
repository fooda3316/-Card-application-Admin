...
import static com.example.adminapplication.api.APIUrl.Page_BASE_URL;


public class RetrofitPageClient {

    private static RetrofitPageClient mInstance;
    ...
    public static synchronized RetrofitPageClient getInstance() {
        if (mInstance == null) {
            mInstance = new RetrofitPageClient();
        }
        return mInstance;
    }
